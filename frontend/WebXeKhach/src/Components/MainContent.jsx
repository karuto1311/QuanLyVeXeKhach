...
function MainContent() {
  ...
  useEffect(() => {
    ...
    const popular = Object.keys(groupedRoutes)
      .slice(0, 3)
      .map((city) => ({
        city,
  ...
  const handleSearch = () => {
    ...
    const results = randomTrips.filter(
      (trip) =>
    ...
    setError(
      results.length === 0 ? "Không tìm thấy chuyến xe nào phù hợp." : ""
    );
    setFilteredTrips(results);
  };

  const images = [slideshow1, slideshow2, slideshow3];
  const shuffledImages = [bgimage1, bgimage2, bgimage3]
    .sort(() => 0.5 - Math.random())
    .slice(0, 3); // Add shuffled images for popular routes
  ...
  return (
    <div className="main-content">
      <div className="search-section">
        ...
        <br />
        <button className="search-button" onClick={handleBook}>
          Đặt vé
        </button>
      </div>
        ...
        <div className="reason-ads">
          <div className="reason">
            <div className="reason-img">
              <img src={Group} alt="homeimg" />
            </div>
            <h2>Hơn 20 Triệu Lượt khách</h2>
            <p>
              {" "}
              Nam Hải phục vụ hơn 20 triệu lượt khách bình quân 1 năm trên toàn
              quốc
            </p>
          </div>
          ...
          <div className="reason">
            <div className="reason-img">
              <img src={Store} alt="homeimg" />
            </div>
            <h2>Hơn 350 Phòng vé - Bưu cục</h2>
            <p>
              Nam Hải có hơn 350 phòng vé, trạm trung chuyển, bến xe,... trên
              toàn hệ thống
            </p>
          </div>
          ...
          <div className="reason">
            <div className="reason-img">
              <img src={Group2} alt="homeimg" />
            </div>
            <h2>Hơn 1,000 Chuyến xe</h2>
            <p>
              Nam Hải phục vụ hơn 1,000 chuyến xe đường dài và liên tỉnh mỗi
              ngày
            </p>
          </div>
        </div>
        <div className="reason-homeimg">
